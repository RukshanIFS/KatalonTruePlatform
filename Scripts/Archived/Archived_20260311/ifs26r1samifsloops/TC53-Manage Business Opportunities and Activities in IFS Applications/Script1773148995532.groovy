...
WebUI.enhancedClick(findTestObject('Archived/Archived_20260311/ifs26r1samifsloops/Page_main_ifsapplications_web_page_BusinessActivity/item_selected'))
...
WebUI.enhancedClick(findTestObject('Archived/Archived_20260311/ifs26r1samifsloops/Page_main_ifsapplications_web_page_BusinessOpportunity/input_account_1'))

"Step 18: Enter input value in input account2"

WebUI.setText(findTestObject('Archived/Archived_20260311/ifs26r1samifsloops/Page_main_ifsapplications_web_page_BusinessOpportunity/input_account2_1'), input_account2)

"Step 19: Click on item internalCustomer"

WebUI.enhancedClick(findTestObject('Archived/Archived_20260311/ifs26r1samifsloops/Page_main_ifsapplications_web_page_BusinessOpportunity/item_internalCustomer_1'))
...
WebUI.enhancedClick(findTestObject('Archived/Archived_20260311/ifs26r1samifsloops/Page_main_ifsapplications_web_page_BusinessActivity/div_description_1'))

"Step 31: Enter input value in input filter"

WebUI.setText(findTestObject('Archived/Archived_20260311/ifs26r1samifsloops/Page_main_ifsapplications_web_page_BusinessActivity/input_filter2'), input_filter)

"Step 32: Press key Enter on input filter2"

WebUI.sendKeys(findTestObject('Archived/Archived_20260311/ifs26r1samifsloops/Page_main_ifsapplications_web_page_BusinessActivity/input_filter2_1'), Keys.chord(Keys.ENTER))
...
WebUI.enhancedClick(findTestObject('Archived/Archived_20260311/ifs26r1samifsloops/Page_main_ifsapplications_web_page_BusinessActivity/button_userDropdown'))

"Step 49: Click on button logout2 -> Navigate to page ''"

WebUI.enhancedClick(findTestObject('Archived/Archived_20260311/ifs26r1samifsloops/Page_main_ifsapplications_web_page_BusinessActivity/button_logout2'))
